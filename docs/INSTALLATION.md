...
The v0.2.0 native package targets 64-bit Ubuntu 24.04 and Linux Mint 22. It
...
2. Download `Greaseweazle-GUI_0.2.0_ubuntu24.04_amd64.deb` and `SHA256SUMS`
...
The `greaseweazle_gui-0.2.0-py3-none-any.whl` wheel attached to this release is
