...
dpkg-deb --info dist/Greaseweazle-GUI_0.2.2_ubuntu24.04_amd64.deb
dpkg-deb --contents dist/Greaseweazle-GUI_0.2.2_ubuntu24.04_amd64.deb
cd dist
sha256sum Greaseweazle-GUI_0.2.2_ubuntu24.04_amd64.deb \
  greaseweazle_gui-0.2.2-py3-none-any.whl > SHA256SUMS
```
...
```sh
git tag -s v0.2.2 -m "Greaseweazle-GUI v0.2.2"
