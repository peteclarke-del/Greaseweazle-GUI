...
that GreaseWeazleGUI has a reader for the filesystem stored inside that format.
...
API or firmware-check failure. Current GreaseWeazleGUI versions keep the device
